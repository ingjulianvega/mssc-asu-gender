...
public class ErrorCodeMessages {
    ...
    public static final String GENDER_NOT_FOUND_API_CODE = "401";
    public static final String GENDER_NOT_FOUND_ERROR = "GENDER_NOT_FOUND";
    public static final String GENDER_NOT_FOUND_MESSAGE = "No se encontró el estado civil";
    public static final String GENDER_NOT_FOUND_SOLUTION = "Verifique los datos";
