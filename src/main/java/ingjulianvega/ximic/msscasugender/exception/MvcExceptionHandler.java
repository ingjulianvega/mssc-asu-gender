...
public class MvcExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public MvcExceptionHandler(GenderParameters genderParameters) {
        this.genderParameters = genderParameters;
    }

    GenderParameters genderParameters;


    @ExceptionHandler(GenderException.class)
    public ResponseEntity<ApiError> validationErrorHandler(GenderException ame) {
        ApiError apiError = ApiError
                .builder()
                .timestamp(LocalDateTime.now())
                .api(genderParameters.getApi())
